...
<body class="bg-gray-100">
	<div class="container mx-auto p-4">
		...
		<div class="header mb-6">
			<a href="./feed.html"><img src="img\futsal062.png" alt="Logo"
				class="h-15 w-40"></a>

			<div class="flex-space-x-4">
				<a href="./feed.html"><button
						class="rounded-button login-button p-4 text-lg"
						style="color: black;">FEED</button></a> <a href="./MyPage.html"><button
						class="rounded-button login-button p-4 text-lg"
						style="color: black;">MY PAGE</button></a> <a href="./FeedWrite.html"><button
						class="rounded-button login-button p-4 text-lg"
						style="color: black;">피드작성</button></a> <a href="./enroll.html"><button
						class="rounded-button login-button p-4 text-lg"
						style="color: black;">매치용병 등록</button></a> <a href="./ViewMatch.html"><button
						class="rounded-button login-button p-4 text-lg"
													...
													<td>
														...
														<div class="comment-form">
															<input type="text" name="C_COMMENT"
																placeholder="댓글을 입력하세요"> <input type="submit"
																value="전송" class="send">
														</div>
													</td>
												</tr>
